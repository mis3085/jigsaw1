...
<section {{ $attributes }}>
  <div class="flex md:flex-row flex-col items-center">
    <div class="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative">
      <img class="w-full h-full object-cover object-center block absolute inset-0 opacity-25" src="https://images.weserv.nl/?output=webp&w=720&url={{ $contents['image'] }}" alt="{{ $contents['title'] }}"/>
