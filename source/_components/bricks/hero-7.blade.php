...
<section {{ $attributes }}>
  <div class="flex md:flex-row flex-col items-center">
    <div class="flex flex-wrap w-full bg-gray-900 py-32 px-10 relative">
      <img class="w-full h-full object-cover object-center block absolute inset-0 opacity-75" src="https://images.weserv.nl/?w=720&url={{ $contents['image'] }}" alt="{{ $contents['title'] }}"/>
